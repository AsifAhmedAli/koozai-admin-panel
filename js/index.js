...
$(document).ready(function () {
    ...
    $("#depositRequestsTable").on("click", ".approve-btn", function () {
        ...
        $("#confirmAmount")
            ...
            .on("click", function () {
                ...
                $.ajax({
                    url: `http://localhost:5000/api/admin/update-user-balance/${depositId}`,
                    method: "PUT",
                    headers: {
    ...
    function fetchDepositRequests() {
        $.ajax({
            url: "http://localhost:5000/api/admin/get-deposit-requests",
            method: "GET",
            headers: {
                Authorization: `Bearer ${token}`,
            },
...
$(document).ready(function () {
    ...
    $.ajax({
        url: `http://localhost:5000/api/admin/get-deposit-history/${userId}`,
        method: "GET",
        headers: {
            Authorization: `Bearer ${token}`,
        },
